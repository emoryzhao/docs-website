...
## Stay in compliance and extend your data retention to avoid data loss

Extending your data retention allows you to analyze, visualize, and receive alert on all your metrics, events, logs, and traces from across all of your sources. However, it’s important to manage that data for cost, performance, and in some cases, compliance reasons. Our data management hub provides the tools you need to understand and control where your data is coming from, and adjust what’s stored and for how long. 

When your data retention exceeds your limit, you lose access to use this data including for use in dashboards, data anlysis, auditing, and compliance needs. For long term data needs, staying in compliance and extending your retention is business critical. See below for details.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Distributed traces (not editable)
      </td>
